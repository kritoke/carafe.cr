...
describe Carafe::Resource do
  ...
  it "#permalink" do
    test_resource("bar.sass", frontmatter: Carafe::Frontmatter.new).permalink.should eq "/bar.css"
    test_resource("bar.scss", frontmatter: Carafe::Frontmatter.new).permalink.should eq "/bar.css"
  end
